            ...
            <div class="w-3/4 mx-4">
                ...
                <form method="POST" action="/project/add" enctype="multipart/form-data">
                    ...
                    <input type='color' name="color" value="#4c4f6d"
                           class="w-2/3 mt-2 mb-6 px-4 py-2 border rounded-lg"/>
                    <br>
                    ...
                    <div class="flex mb-4">
                        <button type="submit"
                                class="w-1/3 mt-2 mb-6 bg-blue-600 text-gray-200 text-lg rounded hover:bg-blue-500 px-6 py-3 focus:outline-none">
                            Create
                        </button>
                        <button type="button" onclick="window.location.href='/project';"
                                class="w-1/3 mt-2 mb-6 bg-red-600 text-gray-100 text-lg rounded hover:bg-red-500 px-6 py-3 focus:outline-none">
                            Back
                        </button>
                    </div>
                </form>
