    ...
    <div class="container mx-auto px-4">
        ...
        <div class="flex -mx-4">
            ...
            <div class="w-3/5 mx-4">
                ...
                <form class="max-w-xl" method="POST" action="/project/add" enctype="multipart/form-data">
                    @csrf
...
{{--                    <div>--}}
{{--                        <label class="text-primary font-light block">Select Video File</label>--}}
                        ...
                        <article aria-label="File Upload Modal"
                            ...
                            <section class="h-full overflow-auto p-8 w-full h-full flex flex-col">
                                <header
                                    ...
                                    <input id="hidden-input" name="video" type="file" multiple class="hidden"/>
                                    <button id="button"
