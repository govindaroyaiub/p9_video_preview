            ...
            <div class="w-3/4 mx-8">
                <div class="videos">
                    ...
                    <div class="video-container aspect-ratio-16-9">
                        ...
                        >
                            <source
                                src="{{ asset('/videos/1920X1080.mp4') }}"
                                type="video/mp4"
                            />
                        </video>
                        <a
                            href="{{ asset('/videos/1920X1080.mp4') }}"
            ...
            <div class="w-1/4 mx-8">
                ...
                <div class="mt-4">
                    ...
                    >
                        ...
                        <a href="{{ '/images/companion-banner.png'  }}"
                    ...
                    <div class="flex">
                        <div class="w-2/4">
                            <div class="video-container aspect-ratio-1-1">
                                ...
                                >
                                    <source
                                        src="{{ asset('/videos/1080X1080.mp4') }}"
                                        type="video/mp4"
                                    />
                                </video>
                                <a
                                    href="{{ asset('/videos/1080X1080.mp4') }}"
                                    class="color-primary underline flex mt-4"
                                    download
                                >Download Video
                                    <svg
